...
class MyBidAuctionVC: UIViewController, IndicatorInfoProvider, NVActivityIndicatorViewable {
    var itemInfo: IndicatorInfo = "BID"
...
extension MyBidAuctionVC: UITableViewDelegate, UITableViewDataSource {
