...
class RegisterVC: UIViewController, UITextFieldDelegate, NVActivityIndicatorViewable {
...
//                    self.moveToCompleteProfile()
    ...
    func moveToCompleteProfile() {
        let completeVC = self.storyboard?.instantiateViewController(withIdentifier: "ProfileEditVC") as! ProfileEditVC
