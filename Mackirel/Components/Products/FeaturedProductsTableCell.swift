//
//  FeaturedProductsTableCell.swift
//  Mackirel
//
...
class FeaturedProductTableCell: UITableViewCell, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
